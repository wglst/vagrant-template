...
public_folder         = "/vagrant/public_html"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "harout" do |vapro|
  end
  ...
  # run_remote  "bash /vagrant/bin/cleanup.sh"
  end

 config.trigger.after :up do
  info "Run some commands ... "
  # run_remote  "bash /vagrant/bin/startup.sh"
  end
